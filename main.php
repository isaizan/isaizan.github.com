...
<html>
  ...
  <div><?php include_once('nav2.html');?></div>
...
<div class="jumbotron masthead">
	...
	<div class="row">
		<div class="span2 offset1">
			<img class="bs-icon" src="img/logo1.png">
	  </div>
		<div class="span8">
			<h1>IsAiZan Savings<small> for Android™</small></h1>
			<small class="pull-right">[from the developers of IsAiZan]</small>
			<p>is ai zan 在布農族的母語中 就代表著</p>
			<p>"因努力而擁有"</p>
			<p class="download-info">
				<a href="http://market.android.com/details?id=tw.com.isaizan.legacy">
	...
	<ul class="quick-links">
		<li class="follow-btn">
			<iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.facebook.com%2Fisaizan&amp;send=false&amp;layout=standard&amp;width=450&amp;show_faces=true&amp;action=like&amp;colorscheme=light&amp;font=trebuchet+ms&amp;height=80&amp;appId=223464487712225" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:80px;" allowTransparency="true"></iframe>
		</li>
...
<div>
	<ul class="thumbnails">
		...
		<li class="span3">
			<a href="#" class="">
				<img src="http://techorange.com/wp-content/uploads/2011/12/logo_to.png">
			</a>
		</li>
		<li class="span3">
			<a href="#" class="">
				<img src="http://iapp.com.tw/static/logo.gif">
			</a>
		</li>
		<li class="span3">
		</li>
...
<div class="marketing row">
	<h1>下載</h1>
	<div class="thumbnail span4 offset2">
		<img src="img/qrcode.png"/>
		<div class="caption">
			<h3 class="">使用手機掃描即可下載</h3>
			<!--
	...
	<div class="span4">
		...
		<p>更新項目<p/>
		<ul>
			<li>使用新帳號重新發佈於 Google Play Store<li/>
		</ul>
		</div>
	</div>
</div>
...
-->
     <!-- Footer <p class="pull-right"><a href="#">Back to top</a></p>
      ================================================== 
	<footer class="footer">
		<p>© 2012 The IsAiZan Team. All rights reserved.</p>
	</footer>-->
    ...
    <div><?php include_once('footer2.html');?></div>
  </body>
</html>
